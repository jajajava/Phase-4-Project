        ...
        <div className="events">
            ...
            <div className="grid-container2">
                ...
                <div className='plant-container'>
                    ...
                    <h1>Hydrangea</h1>
                    <p>Hydrangea, commonly named the hortensia, is a genus of over 75 species of flowering plants native to Asia and the Americas. By far the greatest species diversity is in eastern Asia, notably China, Korea, and Japan.</p>
                </div> 
                ...
                <div className='plant-container'>
                    ...
                    <h1>Philodendron</h1>
                    <p>Philodendron is a large genus of flowering plants in the family Araceae. Taxonomically, the genus Philodendron is still poorly known, with many undescribed species.The name derives from the Greek words philo- or "love, affection" and dendron or "tree".</p>
                </div> 
